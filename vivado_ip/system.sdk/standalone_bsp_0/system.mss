...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_interconnect_axi_dma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.0
 PARAMETER HW_INSTANCE = axi_interconnect_axi_dma_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.0
 PARAMETER HW_INSTANCE = axi_interconnect_axi_dma_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.0
 PARAMETER HW_INSTANCE = axi_interconnect_axi_dma_3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = hls_snn_izikevich
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = hls_snn_izikevich_0
END
