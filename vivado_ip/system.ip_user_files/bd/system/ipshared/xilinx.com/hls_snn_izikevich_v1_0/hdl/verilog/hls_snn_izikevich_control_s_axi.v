...
#(parameter
    ...
    input  wire [1:0]                    p_input_address0,
    input  wire                          p_input_ce0,
    output wire [31:0]                   p_input_q0,
    input  wire [7:0]                    output_indexes_address0,
...
//         others - reserved
// 0x018 : Data signal of state_V
//         bit 0  - state_V[0] (Read/Write)
//         others - reserved
// 0x01c : reserved
// 0x020 ~
// 0x02f : Memory 'p_input' (4 * 32b)
//         Word n : bit [31:0] - p_input[n]
// 0x400 ~
// 0x7ff : Memory 'output_indexes' (159 * 32b)
...
localparam
    ...
    ADDR_STATE_V_DATA_0      = 11'h018,
    ADDR_STATE_V_CTRL        = 11'h01c,
    ADDR_P_INPUT_BASE        = 11'h020,
    ADDR_P_INPUT_HIGH        = 11'h02f,
    ADDR_OUTPUT_INDEXES_BASE = 11'h400,
    ADDR_OUTPUT_INDEXES_HIGH = 11'h7ff,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    RDIDLE                   = 2'd0,
...
//------------------------Local signal-------------------
    ...
    wire [7:0]                    int_output_indexes_address0;
    ...
    wire [7:0]                    int_output_indexes_address1;
...
assign int_p_input_address1        = ar_hs? raddr[3:2] : waddr[3:2];
...
assign int_output_indexes_address1 = ar_hs? raddr[9:2] : waddr[9:2];
