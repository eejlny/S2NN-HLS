...
parameter    ap_const_lv15_7100 = 15'b111000100000000;
...
reg[169:0] neuron_type_mem_V_d0;
(* fsm_encoding = "none" *) reg   [3:0] ap_CS_fsm = 4'b1;
reg    ap_sig_cseq_ST_st1_fsm_0;
reg    ap_sig_bdd_22;
reg   [14:0] indvar_flatten_reg_77;
...
wire   [14:0] indvar_flatten_next_fu_127_p2;
reg   [14:0] indvar_flatten_next_reg_250;
...
wire   [8:0] tmp_651_fu_164_p1;
reg   [8:0] tmp_651_reg_269;
reg   [7:0] neuron_type_mem_V_addr_reg_274;
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1) & (exitcond_flatten_reg_246 == ap_const_lv1_0))) begin
        ...
        indvar_flatten_reg_77 <= ap_const_lv15_0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_1) & (exitcond_flatten_fu_121_p2 == ap_const_lv1_0) & ~(ap_const_lv1_0 == tmp_s_fu_153_p2))) begin
        neuron_type_mem_V_addr_reg_274 <= tmp_38_fu_159_p1;
        tmp_651_reg_269 <= tmp_651_fu_164_p1;
    end
end
...
assign exitcond_flatten_fu_121_p2 = (indvar_flatten_phi_fu_81_p4 == ap_const_lv15_7100? 1'b1: 1'b0);
...
assign indvar_flatten_next_fu_127_p2 = (indvar_flatten_phi_fu_81_p4 + ap_const_lv15_1);

assign l_2_fu_194_p3 = ((tmp_41_fu_168_p2[0:0] === 1'b1) ? l_1_phi_fu_114_p4 : l_fu_180_p2);
...
always @ (neuron_type_mem_V_q0 or tmp_651_reg_269 or tmp_650_fu_222_p3) begin
    neuron_type_mem_V_d0 = neuron_type_mem_V_q0;
    neuron_type_mem_V_d0[tmp_651_reg_269] = tmp_650_fu_222_p3[0];
end



assign tmp_38_fu_159_p1 = $signed(l_1_phi_fu_114_p4);

assign tmp_41_fu_168_p2 = ($signed(y_1_phi_fu_103_p4) < $signed(32'b10101001)? 1'b1: 1'b0);

assign tmp_650_fu_222_p3 = p_Val2_s_fu_54[index_assign_cast1_fu_216_p1];

assign tmp_651_fu_164_p1 = y_1_phi_fu_103_p4[8:0];

assign tmp_fu_147_p2 = (index_assign_mid2_fu_139_p3 == ap_const_lv7_0? 1'b1: 1'b0);

assign tmp_s_fu_153_p2 = ($signed(l_1_phi_fu_114_p4) < $signed(32'b10101010)? 1'b1: 1'b0);

assign y_2_fu_186_p3 = ((tmp_41_fu_168_p2[0:0] === 1'b1) ? y_fu_174_p2 : ap_const_lv32_0);
